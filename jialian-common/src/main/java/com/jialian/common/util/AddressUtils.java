...
//    System.out.println("country:"+country+",area:"+area+",region:"+region+",city:"+city+",county:"+county+",isp:"+isp);
   return city;
  }
  return null;
 }
 ...
 public static void main(String[] args) {
  ...
  System.out.println("ip "+ip+" 的地址为："+address);
  // 输出结果为：广州市
 }
}  
